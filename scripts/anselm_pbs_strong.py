...
# path to exec folder
username = "pos220"
main_folder = "/home/lukas/soft/cuda_scalability";
...
gpu_host_string = ["select=1:ncpus=1:mpiprocs=1:host=cn200,walltime=00:10:00",\
                   "select=1:ncpus=1:mpiprocs=1:host=cn200+1:ncpus=1:mpiprocs=1:host=cn201,walltime=00:10:00",\
                   "select=1:ncpus=1:mpiprocs=1:host=cn200+1:ncpus=1:mpiprocs=1:host=cn201+1:ncpus=1:mpiprocs=1:host=cn202,walltime=00:10:00",\
                   "select=1:ncpus=1:mpiprocs=1:host=cn200+1:ncpus=1:mpiprocs=1:host=cn201+1:ncpus=1:mpiprocs=1:host=cn202+1:ncpus=1:mpiprocs=1:host=cn203,walltime=00:10:00"];
gpu_problem_name = "strong_GPU";

cpu_exec_path = "%s/build_cpu/" %(main_folder);
cpu_host_string = ["select=1:ncpus=1:mpiprocs=1,walltime=00:10:00",\
                   "select=2:ncpus=1:mpiprocs=1,walltime=00:10:00",\
                   "select=3:ncpus=1:mpiprocs=1,walltime=00:10:00",\
                   "select=4:ncpus=1:mpiprocs=1,walltime=00:10:00"]
